...
<div>
	<form action="ActionController" method="post">
		<input type="submit" name="action" value="main"><br>
		type something : <input type="text" name="message">
		<input type="submit" name="action" value="send message"><br><br>
		search : <input type="text" name="keyword">
		<input type="submit" name="action" value="search message">
		<input type="submit" name="action" value="links">
	</form>
	<table cellpadding="5">
